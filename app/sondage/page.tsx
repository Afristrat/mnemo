...
export const metadata: Metadata = {
  title: "Strate, votre avis sur le juste prix",
  description: "2 minutes pour nous aider à fixer un prix juste pour le service Strate.",
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <p className="mt-3 text-slate-600">
        Strate rend la mémoire de votre organisation interrogeable et souveraine. Avant de figer nos tarifs, on
