...
- 2026-05-24 — **S-002 ✅** Design system. Tokens DESIGN.md → tailwind.config (couleurs Material, fontSize sémantiques, rayons card/input, shadow-elevation). Primitives Button/Card/Chip/Input/StatusDot + cn(). Tests 6/6 (jsdom). typecheck 0, lint 0, build OK. Learning : conflit ERESOLVE @vitejs/plugin-react v6↔vitest 2 résolu en épinglant plugin-react@^4 (pas de --force). Prochaine : S-003 (moteur reco).
