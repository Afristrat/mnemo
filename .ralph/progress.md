...
- 2026-05-24 — **S-005 ✅** Wizard 6 étapes (16 params + modules + récap), persistance localStorage, profils-types, preset décidé inline. Route `/configurateur` (21,6 kB). Tests 22/22 (dont 2 wizard). typecheck 0, lint 0, build OK. Learnings : togglers dédiés vs générique union ; `afterEach(cleanup)` obligatoire ; apostrophe typographique en JSX. Prochaine : S-006 (résultats).
