...
- 2026-05-24 — **S-003 ✅** Moteur de reco porté en TS strict (10 fichiers lib/engine). recommend() pur et déterministe. typecheck 0, lint 0, build OK, test 6/6 (tests moteur = S-004). Learning : `noUncheckedIndexedAccess` n'est pas dans `strict` → indexation tableau sûre ; défauts modules en littéral explicite pour éviter `as`. Prochaine : S-004 (tests moteur).
