...
```
== PASSATION MNEMO 2026-05-25T02:30 ==
[ETAT]    Lot 1 (conseil+moats) en cours | 11/14 stories ✓ | branche main propre | build ✓ | t 74/74 ✓
[ENCOURS] > S-012 Supabase + RLS + auth + consentement (next, pas commencé) — RUN AUTONOME en cours
[FAIT]    S-001→S-010 + S-011 Fiduciary Mode (/fiduciaire + charte dans livrable) | Supabase local prêt | docs/DECISIONS.md ADR-001..005
