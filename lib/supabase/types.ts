...
export type ResidencyContinuityObservationInsert = {
  ...
  components: { id: string; region: string | null; flag: string; legalBasis: string | null }[];
  integrity_hash: string;
  observed_at: string;
};
export type ResidencyContinuityObservationRow = ResidencyContinuityObservationInsert & {
  id: string;
  created_at: string;
};
